...
class Player:
    ...
    def update(self, keys):
        ...
        # --- SUPER PEEL-OUT LOGIC (UP+Z, run on release) ---
        ...
        # --- SPINDASH LOGIC (DOWN + Z, roll on release) ---
        ...
        elif self.y + self.height > 440:
            self.y = 440 - self.height
            self.y_velocity = 0
            self.on_ground = True
            self.air_x_speed = self.ground_speed
        else:
