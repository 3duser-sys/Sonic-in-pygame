...
level_slopes = [
    ...
    {'start': (800, 400), 'end': (1000, 410)},
    {'start': (1000, 410), 'end': (1200, 380)},
    {'start': (1200, 380), 'end': (1400, 420)},
    {'start': (1400, 420), 'end': (1600, 410)},
    {'start': (1600, 410), 'end': (1800, 430)},
...
def show_title_screen(screen):
    ...
    sega_img = pygame.transform.scale(sega_img, (WIDTH, HEIGHT))
    ...
    while True:
        ...
        if blink_timer >= BLINK_INTERVAL:
            ...
            blink_timer = 0
        if blink:
            prompt_text = prompt_font.render("Press any button", True, (255, 255, 0))
            screen.blit(prompt_text, (WIDTH // 2 - prompt_text.get_width() // 2, HEIGHT - 80))
        pygame.display.flip()
        clock.tick(60)
